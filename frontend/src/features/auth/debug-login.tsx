...
export function DebugLogin() {
  ...
  const testLogin = async () => {
    setIsLoading(true)
    addResult('info', 'Testing login with credentials...', { username, password })
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm space-y-1">
                <div><strong>Base URL:</strong> {import.meta.env.VITE_API_BASE_URL || 'http://localhost:3111'}</div>
                <div><strong>Endpoint:</strong> /auth/login</div>
