...
export interface IRolePermissionRepository {
  ...
  assignPermission(rolePermission: Partial<RolePermission>): Promise<RolePermission>;
  ...
  bulkAssignPermissions(rolePermissions: Partial<RolePermission>[]): Promise<RolePermission[]>;
}
